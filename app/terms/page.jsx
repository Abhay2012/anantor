      ...
      <section className={styles.container}>
        ...
        <div style={{ display: 'grid', gap: '1.5rem' }}>
          ...
          <section>
            ...
            <h3 className={styles.p} style={{ fontWeight: 600, marginBottom: '0.5rem' }}>4.3 Our Intellectual Property</h3>
            ...
            <h3 className={styles.p} style={{ fontWeight: 600, marginBottom: '0.5rem' }}>4.4 Restrictions on Use</h3>
            ...
            <h3 className={styles.p} style={{ fontWeight: 600, marginBottom: '0.5rem' }}>4.5 AI-Generated Content</h3>
          ...
          <section>
            ...
            <h3 className={styles.p} style={{ fontWeight: 600, marginBottom: '0.5rem' }}>5.2 Consequences of Prohibited Conduct</h3>
